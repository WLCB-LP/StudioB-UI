# STUB Mixer UI (Studio B) — Release 0.3.17
...
- v0.3.17: Studio mixer polish: stronger fader lane glow + color-only neon MUTE (no "ON" badge) with dim fill + bright border.
