# STUB Mixer UI (Studio B) — Release 0.4.07
...
- v0.4.07: UI polish: consistent top-row card height, improved title pills, larger WLCB Status text, and tighter top↔bottom row spacing.
