# STUB Mixer UI (Studio B) — Release 0.3.35
...
- v0.3.35: UI-only: Layout polish — keep **PC + Zoom** inline (no vertical stacking) and enforce **no scrolling** on the Studio fader bank.
