# STUB Mixer UI (Studio B) — Release 0.3.21
...
- v0.3.21: Installer health checks are **retry-based** (tolerant of slow restarts) and print `systemctl/journalctl` diagnostics on failure.
